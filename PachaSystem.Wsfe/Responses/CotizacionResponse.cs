// <copyright file="CotizacionResponse.cs" company="Pacha System">
...
namespace PachaSystem.Wsfe.Responses
{
    ...
    [DataContract(Name = "FECotizacionResponse", Namespace = "http://ar.gov.afip.dif.FEV1/")]
    public class CotizacionResponse
    {
        private Cotizacion _resultados;
        private List<Error> _errores;
        private List<Evento> _eventos;

        [DataMember(Name = "ResultGet", Order = 0)]
        public Cotizacion Resultados
        {
            get
            {
                return _resultados;
