...
namespace PachaSystem.Wsfe
{
    ...
    public class WsfeClient : ClientBase<IWsfeClient>, IWsfeClient
    {
        ...
        public RecuperarUltimoComprobanteResponse ObtenerUltimoComprobante(Credenciales credenciales, int puntoDeVenta, int tipoDeComprobante)
        {
            return base.Channel.ObtenerUltimoComprobante(credenciales, puntoDeVenta, tipoDeComprobante);
        }
